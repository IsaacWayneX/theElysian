        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <Button variant="ghost" size="sm" className="text-white hover:text-yellow-300 hover:bg-yellow-500/10 rounded-full w-10 h-10">
            ...
            {/* CTA Button */}
            <Button 
              className="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-2 rounded-xl transition-all duration-300 hover:scale-105"
              onClick={onOpenModal}
            >
              Book a consultation
            </Button>
          ...
          <div className="md:hidden">
            <Button
              ...
              size="sm"
              onClick={toggleMenu}
              className="text-white hover:text-yellow-300 hover:bg-yellow-500/10"
            >
              {isMenuOpen ? (
                <X className="h-6 w-6" />
              ) : (
