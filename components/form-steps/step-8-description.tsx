      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-center md:justify-between py-4 md:py-0 h-full">
        ...
        <div className="flex-1 max-w-2xl w-full md:max-w-2xl flex flex-col justify-center">
          <div className="space-y-6 md:space-y-12">
            ...
            <p className="text-sm sm:text-lg md:text-2xl text-gray-300 text-center md:text-left font-bold" style={{ fontFamily: 'var(--font-nohemi)' }}>
              Share your story, products, and what you'll showcase at the exhibition.
            </p>

            {/* Form */}
            <div className="space-y-4 md:space-y-8">
              <div className="space-y-2 md:space-y-4">
                <Label htmlFor="description" className="text-white text-sm sm:text-lg md:text-2xl font-bold block text-center md:text-left" style={{ fontFamily: 'var(--font-nohemi)' }}>
                  Company Description
                </Label>
                <Textarea
                  id="description"
                  ...
                  className="bg-transparent border-0 border-b border-gray-600 text-white placeholder:text-gray-500 text-2xl sm:text-4xl md:text-6xl font-black py-3 md:py-6 px-0 focus:border-gray-600 focus:ring-0 focus:outline-none rounded-none min-h-[120px] md:min-h-[200px] resize-none"
                  autoFocus
                />
        ...
        <div className="hidden md:flex flex-1 max-w-lg md:ml-16 relative w-full">
          <div className="relative">
            <Image
              src="https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800&h=800&fit=crop"
              alt="Company description and innovation"
              width={600}
              height={600}
