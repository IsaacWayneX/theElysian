        ...
        <div className="flex-1 max-w-2xl w-full md:max-w-2xl h-full flex flex-col justify-center">
          <div className="space-y-6 md:space-y-12 overflow-y-auto max-h-full pr-2 py-4 scrollbar-hide">
            ...
            <div className="space-y-4 md:space-y-8">
              <div className="space-y-2 md:space-y-4">
                <Label htmlFor="description" className="text-white text-sm sm:text-base md:text-lg lg:text-xl font-bold block text-center md:text-left" style={{ fontFamily: 'var(--font-nohemi)' }}>
                  Company Description
                </Label>
                <Textarea
                  id="description"
                  ...
                  className="bg-transparent border-0 border-b border-gray-600 text-white placeholder:text-gray-500 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black py-2 md:py-4 px-0 focus:border-gray-600 focus:ring-0 focus:outline-none rounded-none min-h-[120px] md:min-h-[200px] resize-none"
                  autoFocus
                />
