...
export function Step9SpecialRequirements() {
  const { formData, updateFormData, nextStep, prevStep } = useMultiStepForm()
  const [value, setValue] = useState(formData.specialRequirements)

  const handleContinue = () => {
    updateFormData('specialRequirements', value.trim())
    nextStep()
  }
        ...
        <div className="flex-1 max-w-2xl w-full md:max-w-2xl h-full flex flex-col justify-center">
          <div className="space-y-6 md:space-y-12 overflow-y-auto max-h-full pr-2 py-4 scrollbar-hide">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 text-center md:text-left font-bold" style={{ fontFamily: 'var(--font-nohemi)' }}>
              Let us know about any special setup needs, equipment, or additional services you might require.
            </p>

            {/* Form */}
            <div className="space-y-4 md:space-y-8">
              <div className="space-y-2 md:space-y-4">
                <Label htmlFor="specialRequirements" className="text-white text-sm sm:text-base md:text-lg lg:text-xl font-bold block text-center md:text-left" style={{ fontFamily: 'var(--font-nohemi)' }}>
                ...
                <Textarea
                  ...
                  placeholder="e.g., Electrical outlets..."
                  className="bg-transparent border-0 border-b border-gray-600 text-white placeholder:text-gray-500 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black py-2 md:py-4 px-0 focus:border-gray-600 focus:ring-0 focus:outline-none rounded-none min-h-[100px] md:min-h-[150px] resize-none"
                  autoFocus
                />
                <p className="text-gray-400 text-sm sm:text-lg md:text-xl font-bold" style={{ fontFamily: 'var(--font-nohemi)' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 pt-4 md:pt-8">
                ...
                <Button
                  ...
                  className="flex-1 bg-white hover:bg-gray-100 text-black px-4 sm:px-12 py-3 sm:py-6 text-sm sm:text-lg md:text-xl lg:text-2xl font-bold flex items-center justify-center gap-2 sm:gap-4 rounded-none border-0"
                >
                  Continue
        ...
        <div className="hidden md:flex flex-1 max-w-lg md:ml-16 relative w-full">
          <div className="relative">
            <Image
              ...
              alt="Special requirements and setup"
              width={600}
              height={600}
