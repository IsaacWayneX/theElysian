          ...
          <div className="space-y-6 md:space-y-12">
            ...
            <div className="space-y-4 md:space-y-8">
              <div className="space-y-2 md:space-y-4">
                <Label htmlFor="specialRequirements" className="text-white text-sm sm:text-lg md:text-2xl font-bold block text-center md:text-left" style={{ fontFamily: 'var(--font-nohemi)' }}>
                ...
                <Textarea
                  ...
                  className="bg-transparent border-0 border-b border-gray-600 text-white placeholder:text-gray-500 text-2xl sm:text-4xl md:text-6xl font-black py-3 md:py-6 px-0 focus:border-gray-600 focus:ring-0 focus:outline-none rounded-none min-h-[100px] md:min-h-[150px] resize-none"
                  autoFocus
                />
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 pt-4 md:pt-8">
                ...
                <Button
                  ...
                  className="flex-1 bg-white hover:bg-gray-100 text-black px-4 sm:px-16 py-4 sm:py-8 text-sm sm:text-xl md:text-2xl font-bold flex items-center justify-center gap-2 sm:gap-4 rounded-none border-0"
                >
                  Continue
