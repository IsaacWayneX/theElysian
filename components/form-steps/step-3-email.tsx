...
export function Step3Email() {
  ...
  const handleKeyPress = (e: React.KeyboardEvent) => {
    if (e.key === 'Enter' && value.trim() && validateEmail(value.trim())) {
      handleContinue()
    }
  }
    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-center md:justify-between py-4 md:py-0">
        ...
        <div className="flex-1 max-w-2xl w-full md:max-w-2xl">
          <div className="space-y-6 md:space-y-12">
            ...
            <p className="text-sm sm:text-lg md:text-2xl text-gray-300 text-center md:text-left font-bold" style={{ fontFamily: 'var(--font-nohemi)' }}>
              We'll use this to send you important updates about the exhibition.
            </p>

            {/* Form */}
            <div className="space-y-4 md:space-y-8">
              <div className="space-y-2 md:space-y-4">
                <Label htmlFor="email" className="text-white text-sm sm:text-lg md:text-2xl font-bold block text-center md:text-left" style={{ fontFamily: 'var(--font-nohemi)' }}>
                  Email Address
                </Label>
                <div className="relative">
                  <Input
                    ...
                    className={`bg-transparent border-0 border-b text-white placeholder:text-gray-500 text-2xl sm:text-4xl md:text-6xl font-black py-3 md:py-6 px-0 focus:ring-0 focus:outline-none rounded-none ${
                      !isValid ? 'border-red-500' : 'border-gray-600 focus:border-gray-600'
                    }`}
                    autoFocus
                  />
                </div>
                {!isValid && (
                  <p className="text-red-400 text-sm sm:text-lg md:text-xl font-bold" style={{ fontFamily: 'var(--font-nohemi)' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 pt-4 md:pt-8">
                ...
                <Button
                  ...
                  disabled={!value.trim() || !validateEmail(value.trim())}
        ...
        <div className="hidden md:flex flex-1 max-w-lg md:ml-16 relative w-full">
          <div className="relative">
            <Image
              src="https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=800&h=800&fit=crop"
